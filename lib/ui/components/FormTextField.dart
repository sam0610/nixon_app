...
class MyFormNumberField extends StatefulWidget {
  MyFormNumberField(
      {this.labelText,
      this.initialValue,
      this.onSave,
  ...
  @override
  _MyFormNumberFieldState createState() => new _MyFormNumberFieldState();
}

class _MyFormNumberFieldState extends State<MyFormNumberField> {
  @override
  void initState() {
    super.initState();
    if (widget.controller != null)
